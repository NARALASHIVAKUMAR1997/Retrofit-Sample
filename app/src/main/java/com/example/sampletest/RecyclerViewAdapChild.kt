...
class RecyclerViewAdapChild(val context: Context, val list: List<Example>) :
    RecyclerView.Adapter<RecyclerViewAdapChild.MYViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MYViewHolder {
        return MYViewHolder(
            LayoutInflater.from(context).inflate(R.layout.sample_layout, parent, false)
        )
    }
